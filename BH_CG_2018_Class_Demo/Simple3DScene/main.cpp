...
void init_shaders(void)
{
	g_simple_GLSL_prog=InitShader(
		...
		"..\\shaders\\multi_lights-phone_shading-vs.txt",
		"..\\shaders\\multi_lights-phone_shading-fs.txt"
		);
	...
	glUniform4f(loc, 0.7f, 0.7f, 0.7f, 0.7f);
...
void init_models(void)
{
	...
	g_models[0].mesh.CreateRect(6.0f, 5.0f, 12, 10);
	//g_models[1].mesh.CreateGasket3D(tetra_v, 3);
	//g_models[2].mesh.CreateCube(1.0f);
	g_models[3].mesh.CreateSphere(0.6f, 32, 16);
	...
	g_models[0].diffuse_color=vec4(0.7f, 0.7f, 0.7f, 1.0f);
